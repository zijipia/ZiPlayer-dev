	...
	youtubeplugin: {
		...
		methods: [
			...
			},
			{
				...
				description:
					"Retrieves the audio stream for a YouTube track. This method extracts the audio stream from a YouTube video using the YouTube client. It attempts to get the best quality audio stream available and handles various format fallbacks if the primary method fails.",
				example:
