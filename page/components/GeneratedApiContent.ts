...
export const generatedApiContent = {
	...
	extensioncontext: {
		...
		badges: ["interface", "core", "extensioncontext"],
	...
	extensionplayrequest: {
		...
		badges: ["interface", "core", "extensionplayrequest"],
	...
	extensionplayresponse: {
		...
		badges: ["interface", "core", "extensionplayresponse"],
	...
	extensionafterplaypayload: {
		...
		badges: ["interface", "core", "extensionafterplaypayload"],
	...
	extensionstreamrequest: {
		...
		badges: ["interface", "core", "extensionstreamrequest"],
	...
	extensionsearchrequest: {
		...
		badges: ["interface", "core", "extensionsearchrequest"],
	...
	sourceplugin: {
		...
		badges: ["interface", "core", "sourceplugin"],
	...
	sourceextension: {
		...
		badges: ["interface", "core", "sourceextension"],
	...
	youtubeplugin: {
		...
		badges: ["class", "core", "youtubeplugin"],
	...
	soundcloudplugin: {
		...
		badges: ["class", "core", "soundcloudplugin"],
	...
	spotifyplugin: {
		title: "SpotifyPlugin",
		description:
			"This minimal Spotify plugin: - Parses Spotify URLs/URIs (track/playlist/album) - Uses Spotify's public oEmbed endpoint to fetch *display metadata* (no auth, no SDK) - Does NOT provide audio streams (player is expected to redirect/fallback upstream) - Does NOT expand playlists/albums (no SDK; oEmbed doesn't enumerate items) /",
		badges: ["class", "core", "spotifyplugin"],
	...
	ttspluginoptions: {
		...
		badges: ["interface", "core", "ttspluginoptions"],
